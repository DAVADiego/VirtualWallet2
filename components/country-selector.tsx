...
export type CountrySelectorProps = {
  onSelect: (country: { value: string; label: string; flag: string; currency: string }) => void
  defaultValue?: string
  placeholder?: string
}

export function CountrySelector({ onSelect, defaultValue, placeholder = "Seleccionar país" }: CountrySelectorProps) {
