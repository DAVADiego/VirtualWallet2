...
import { ArrowDown, ArrowUp, CreditCard, Download, Home, Search, SlidersHorizontal } from "lucide-react"
                ...
                <div className="flex items-center justify-between p-4 border-b">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">16 mar · Dinero enviado</p>
                    </div>
                  </div>
                  <div className="flex flex-col items-end">
