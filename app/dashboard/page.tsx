        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <CardContent>
                  ...
                  <div className="mt-4 bg-white/10 p-3 rounded-md flex items-center space-x-2 backdrop-blur-sm">
                    <div className="text-sm">
                      ...
                      <Link href="#" className="block text-blue-200 hover:text-blue-100">
                        Ver detalles
                      </Link>
                    </div>
                  </div>
            ...
            <Card>
              <CardHeader className="pb-2 flex flex-row items-center justify-between">
                ...
                <Link href="/movimientos" className="text-primary-500 hover:underline text-sm">
                  Ver todos
                </Link>
              </CardHeader>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" className="w-full" asChild>
                  <Link href="/tasas">Ver todas las tasas</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardFooter>
                <Button variant="outline" className="w-full" asChild>
                  <Link href="/cartera">Administrar métodos de pago</Link>
                </Button>
              </CardFooter>
            </Card>
